...
while True:
    ...
    if handsPoints != None:
        for hand in handsPoints:
            ...
            cv2.rectangle(img, (x_min-50, y_min-50), (x_max+50, y_max+50), (0, 55, 0), 2)
            ...
            try:
                ...
                cv2.putText(img, classes[indexVal],(x_min-50,y_min-65),cv2.FRONT_HERSHEY_COMPLEX,3,(0,00,255),5)
